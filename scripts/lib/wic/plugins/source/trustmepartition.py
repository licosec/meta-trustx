...
class TrustmeDataPlugin(SourcePlugin):
    ...
    def do_prepare_partition(cls, part, source_params, creator, cr_workdir,
        ...
        install_cmd = "install -d %s/userdata/cml/containers" % hdddir 
        exec_cmd(install_cmd)
        ...
        cp_cmd = "cp -ar {0}/trustx-configs/container/. {1}/userdata/cml/containers/".format(deploy_dir_image, hdddir)
        exec_cmd(cp_cmd)
